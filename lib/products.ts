...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    features: [
      {
        num: "01",
        heading: "오로라 글로우 그래픽",
        body: "낮에는 무광 블랙에 잠겨 있다가, 가로등·헤드라이트를 받으면 라임 오로라가 떠오른다. 새벽 4시 도로에서 차가 먼저 너를 본다 — 안전이 곧 디자인이다.",
      },
      {
        num: "02",
        heading: "흡습속건 테크니컬 원단",
        body: "땀을 빠르게 흡수해 바깥면으로 밀어내는 평직 구조. 젖어도 몸에 붙거나 무거워지지 않고, 면보다 4배 빨리 마른다.",
      },
      {
        num: "03",
        heading: "세미 루즈 + 플랫락 봉제",
        body: "달릴 때 펄럭이지 않고 걸을 때 붙지 않는 5cm의 여유. 전 구간 플랫락 스티치로 솔기 단차를 없애 겨드랑이 쓸림을 막았다.",
      },
    ],
    lifestyleImage: "/hero/hero-night-crew.jpg",
    specs: [
      ["소재", "폴리에스터 90% / 스판덱스 10%"],
      ["무게", "138g (M)"],
      ["핏", "세미 루즈"],
    ...
    crewPick: "CATTIVO",
    crewComment: "어두울수록 더 튀어. 그게 핵심이야.",
  },
  {
