export function MvPlayer({
  ...
  return (
    <figure className="overflow-hidden rounded-3xl border border-darkline bg-coal">
      <video
        controls
        playsInline
        preload="none"
      ...
      <figcaption className="flex items-baseline justify-between gap-4 p-5">
        ...
        <svg viewBox="0 0 60 16" className="h-3 w-12 shrink-0 text-flow" fill="none" aria-hidden>
          <polyline
